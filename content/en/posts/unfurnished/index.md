...
translationKey: unfurnished # If you have a translated post for this one, set the same translationKey to have the translation displayed
draft: false # Set wether this post is a draft
layout: 'single'
---

## The House Unfirnished

This is the current "move in" state of the house, without furniture.

<div id="carouselLoft" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-indicators">
    ...
    <button type="button" data-bs-target="#carouselLoft" data-bs-slide-to="5" aria-label="Slide 6"></button>
    <button type="button" data-bs-target="#carouselLoft" data-bs-slide-to="6" aria-label="Slide 7"></button>
    <button type="button" data-bs-target="#carouselLoft" data-bs-slide-to="7" aria-label="Slide 8"></button>
  </div>
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images/living-room.jpeg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
          <h5>The open plan living and dining room</h5>
        </div>
    </div>
    <div class="carousel-item active">
    ...
    <div class="carousel-item active">
      <img src="images/mezzanine.jpeg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
          <h5>The mezzanine</h5>
        </div>
    </div>
    <div class="carousel-item active">
      <img src="images/first-floor.jpeg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
          <h5>The first floor mezzanine and upper hall</h5>
        </div>
    </div>
    <div class="carousel-item active">
      <img src="images/bedroom1.jpeg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
          <h5>The first bedroom</h5>
        </div>
    </div>
    <div class="carousel-item active">
      <img src="images/bedroom2.jpeg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
          <h5>The second bedroom</h5>
        </div>
    </div>
    <div class="carousel-item active">
      <img src="images/loft-bedroom.jpeg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
          <h5>The master bedroom</h5>
        </div>
    </div>
    <div class="carousel-item active">
      <img src="images/loft-bedroom2.jpeg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
